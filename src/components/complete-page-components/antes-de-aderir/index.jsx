...
const Container = ({ setState }) => {
    const checkedRef = useRef(false);

    const clickHandler = () => {
        setState("TIPO_USUARIO")
    };
    ...
    return (
        <section className={classNames(classes.container, `border border-gray-300 border-solid mx-auto my-12
            ...
            <div className="mt-4">
                <Checkbox checkedRef={checkedRef} />
            </div>
            <div className="flex mt-8">
                <Button 
                    className="bg-black border-black mr-4 px-4 py-2 text-white hover:bg-neutral-700"
